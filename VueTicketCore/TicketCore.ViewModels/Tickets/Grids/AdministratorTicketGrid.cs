...
{
    public class AdministratorTicketGrid
    {
        [Display(Name = "Agent")]
        ...
        public long? AgentManagerId { get; set; }
        public List<SelectListItem> ListofAgentManagers { get; set; }
    ...
    public class AdministratorTicketGridViewModel
    {
