...
namespace TicketCore.Data.MenuMasters.Queries
{
    public class MenuMasterQueries : IMenuMasterQueries
    {
        ...
        public MenuMasterQueries(VueTicketDbContext vueTicketDbContext, IMemoryCache cache)
        {
        ...
        public bool CheckMenuNameExists(string menuName)
        {
            try
            {
                var result = (from menu in _vueTicketDbContext.MenuMasters
        ...
        public bool CheckMenuExists(string menuName, int? roleId, int? categoryId)
        {
            try
            {
                var result = (from menu in _vueTicketDbContext.MenuMasters.AsNoTracking()
        ...
        public IQueryable<MenuMasterGrid> ShowAllMenus(string sortColumn, string sortColumnDir, string search)
        {
            try
            {
                var queryableMenuMaster = (from menu in _vueTicketDbContext.MenuMasters
                                           join category in _vueTicketDbContext.MenuCategorys on menu.MenuCategoryId equals category.MenuCategoryId
                                           join roleMaster in _vueTicketDbContext.RoleMasters on menu.RoleId equals roleMaster.RoleId
        ...
        public EditMenuMasterViewModel GetMenuByMenuId(int? menuId)
        {
            try
            {
                var editmenu = (from menu in _vueTicketDbContext.MenuMasters
        ...
        {
            var listofactiveMenus = (from tempmenu in _vueTicketDbContext.MenuMasters
