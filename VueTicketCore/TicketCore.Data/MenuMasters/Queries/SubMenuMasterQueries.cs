...
namespace TicketCore.Data.MenuMasters.Queries
{
    public class SubMenuMasterQueries : ISubMenuMasterQueries
    {
        ...
        public SubMenuMasterQueries(VueTicketDbContext vueTicketDbContext, IMemoryCache cache)
        {
        ...
        public bool CheckSubMenuNameExists(string subMenuName, int menuId)
        {
            try
            {
                var result = (from submenu in _vueTicketDbContext.SubMenuMasters.AsNoTracking()
        ...
        public EditSubMenuMasterViewModel GetSubMenuById(int? subMenuId)
        {
            try
            {
                var result = (from submenu in _vueTicketDbContext.SubMenuMasters
        ...
        public IQueryable<SubMenuMasterViewModel> ShowAllSubMenus(string sortColumn, string sortColumnDir, string search)
        {
            try
            {
                var queryablesSubMenuMasters = (from submenu in _vueTicketDbContext.SubMenuMasters
                                                join category in _vueTicketDbContext.MenuCategorys on submenu.MenuCategoryId equals category.MenuCategoryId
                                                join roleMaster in _vueTicketDbContext.RoleMasters on submenu.RoleId equals roleMaster.RoleId
                                                join menuMaster in _vueTicketDbContext.MenuMasters on submenu.MenuId equals menuMaster.MenuId
        ...
        {
            var listofactivesubMenus = (from tempsubmenu in _vueTicketDbContext.SubMenuMasters
