namespace TicketCore.Common
{
    ...
    {
        public const string DepartmentAlreadyExistsMessages = "Department Name Already Exists";
        public const string DepartmentSuccessMessages = "Department Name added successfully.";
