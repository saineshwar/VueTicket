...
namespace TicketCore.Web.Areas.User.Controllers
{
    ...
    public class MyAccountController : Controller
    {
        ...
        public MyAccountController(
            ...
            IUserMasterCommand userMasterCommand, IDepartmentQueries departmentQueries)
        {
        ...
        public IActionResult Members()
        {
            ...
            var listofdepartment = _departmentQueries.GetAssignedDepartmentsofAgentManager(userId);
            var teamMembersModel = new TeamMembersModel()
            {
                ListofDepartments = listofdepartment
            };
            return View(teamMembersModel);
        }

        public IActionResult GetTeamList(RequestTeamViewModel requestBug)
        {
            var listofteam = _userMasterQueries.GetTeam(requestBug.DepartmentId);
