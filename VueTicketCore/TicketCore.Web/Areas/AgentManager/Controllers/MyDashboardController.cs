...
namespace TicketCore.Web.Areas.AgentManager.Controllers
{
    ...
    public class MyDashboardController : Controller
    {
        ...
        public MyDashboardController(IDepartmentQueries departmentQueries,
            ...
            ITicketNotificationQueries ticketNotificationQueries,
            ITicketNotificationCommand ticketNotificationCommand, IChartsQueries chartsQueries, INotificationService notificationService)
        {
            _departmentQueries = departmentQueries;
            _dashboardQueries = dashboardQueries;
            _iTicketNotificationQueries = ticketNotificationQueries;
            _iTicketNotificationCommand = ticketNotificationCommand;
        ...
        public IActionResult Dashboard()
        {
            ...
            {
                ListofDepartments = _departmentQueries.GetAssignedDepartmentsofAgentManager(userId)
            };
